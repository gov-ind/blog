    ...
    return (
      ...
      <div className='main'>
        <div className='content'>
          ...
          <div className='space'>The function as such is pretty simple. It takes as input the big rectangle's dimensions <Latex>$L$ and $W$, and $k$ smaller rectangles</Latex>, and tries to pack a combination of one or more of these small rectangles such that the either the wasted length or height is minimized. For example, given <Latex>$L = 17$ and $W = 7$, and four rectangles $(5, 7), (3, 11), (7, 3), and (11, 5)$, one naive approach is to just pack three $(5, 7)$</Latex> rectangles horizontally like this and minimize wasted length.
          </div>
          <img src={fig2} />
          <div className='space'>
          ...
          <img src={fig7} />
          <div className='space'>
            As it turns out, it packs one of these rectangles pretty well, but there's wasted horizontal space for the left grey rectangle. No worries, because if we further partition this one into two more rectangles horizontally and ask the function to optimize it, it will happily do so.
          </div>
          <img src={fig8} /><br />
          <img src={fig9} />
          <div className='space'>
